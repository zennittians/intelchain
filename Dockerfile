...
RUN git clone https://github.com/zennittians/intelchain.git ${ITC_PATH}/intelchain

RUN git clone https://github.com/zennittians/bls.git ${ITC_PATH}/bls

RUN git clone https://github.com/zennittians/mcl.git ${ITC_PATH}/mcl

RUN git clone https://github.com/zennittians/go-sdk.git ${ITC_PATH}/go-sdk
