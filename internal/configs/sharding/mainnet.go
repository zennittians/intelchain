...
var (
	mainnetV0   = MustNewInstance(4, 150, 112, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccounts, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV0_1 = MustNewInstance(4, 152, 112, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV0_1, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV0_2 = MustNewInstance(4, 200, 148, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV0_2, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV0_3 = MustNewInstance(4, 210, 148, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV0_3, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV0_4 = MustNewInstance(4, 216, 148, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV0_4, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV1   = MustNewInstance(4, 250, 170, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV1_1 = MustNewInstance(4, 250, 170, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_1, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV1_2 = MustNewInstance(4, 250, 170, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_2, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV1_3 = MustNewInstance(4, 250, 170, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_3, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV1_4 = MustNewInstance(4, 250, 170, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_4, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV1_5 = MustNewInstance(4, 250, 170, numeric.OneDec(), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_5, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV2_0 = MustNewInstance(4, 250, 170, numeric.MustNewDecFromStr("0.68"), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_5, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV2_1 = MustNewInstance(4, 250, 130, numeric.MustNewDecFromStr("0.68"), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_5, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV2_2 = MustNewInstance(4, 250, 90, numeric.MustNewDecFromStr("0.68"), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_5, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpochOld())
	mainnetV3   = MustNewInstance(4, 250, 90, numeric.MustNewDecFromStr("0.68"), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_5, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpoch())
	mainnetV3_1 = MustNewInstance(4, 250, 90, numeric.MustNewDecFromStr("0.60"), genesis.IntelchainAccounts, genesis.FoundationalNodeAccountsV1_5, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpoch())
)
