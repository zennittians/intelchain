...
func validateIntelchainConfig(config intelchainConfig) error {
	var accepts []string
...
var dumpConfigCmd = &cobra.Command{
	...
	Short: "dump the config file for intelchain binary configurations",
	Long:  "dump the config file for intelchain binary configurations",
...
func loadIntelchainConfig(file string) (intelchainConfig, error) {
	b, err := ioutil.ReadFile(file)
	if err != nil {
		return intelchainConfig{}, err
	}

	var config intelchainConfig
...
func writeIntelchainConfigToFile(config intelchainConfig, file string) error {
